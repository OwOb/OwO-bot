...
bot.on("message", function(message) {
  ...
  if(!isself && headlower == "!test") {
    ...
    */
    ...
    var richembed = new Discord.RichEmbed().setColor(11068927).setTitle("**"+mikumessage[Math.floor(Math.random()*mikumessage.length)]+"**").setImage("./image/39/"+to02d(Math.floor(Math.random()*12)+1)+".jpg");
