            ...
            if (/^\d+(\:\d+)?$/.test(s_id)) {
              ...
              s_func = function(body) {
                ...
                if (!p_json.error) {
                  ...
                  var p_image_width = p_illust.illust_images[s_page].illust_image_width, p_image_height = p_illust.illust_images[s_page].illust_image_height, p_image_date = new Date(p_illust.upload_timestamp*1000);
